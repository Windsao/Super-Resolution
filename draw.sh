...
CUDA_VISIBLE_DEVICES=0 python main.py --model RFDN --scale 4 --patch_size 256 --beta 1 --save debug --epochs 500 --reset --distil --teacher_model 'EDSR_paper' --data_aug 'SI_mask' --t_ratio 0.3
