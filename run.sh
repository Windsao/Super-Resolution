...
#HIP_VISIBLE_DEVICES=$1 python main.py --model RFDN --scale 2 --patch_size 64 --save baseline_rfdn_x2 --reset > test_$1.txt 2>&1 &
#HIP_VISIBLE_DEVICES=$1 python main.py --model RFDN --scale 2 --patch_size 64 --beta $2 --save distil_rfdn_x2_$2 --reset --distil > test_$1.txt 2>&1 &
HIP_VISIBLE_DEVICES=$1 python main.py --model RFDN --scale 2 --patch_size 64 --beta $2 --save cutmix0.05_rfdn_x2_$2 --reset --distil --cutmix --aug_alpha 0.05 > test_$1.txt 2>&1 &
